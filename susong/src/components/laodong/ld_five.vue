<template>
  <div id="box">
    ...
    <p>{{title}}</p>
    <!-- 单选题选择 -->
    <el-radio-group v-model="selectionsList[4].value" @change="changeValue">
...
export default {
  data() {
    return {
      title: "您解除劳动关系的原因是？",
      radio1: "",
      one: "用人单位以违反公司规定为由解除劳动关系",
      two: "临退休被辞退，我请求用人单位支付经济赔偿",
      three: "主动辞职，我请求用人单位支付经济补偿",
      four:"因其他原因解除劳动关系，我请求用人单位支付经济补偿或经济赔偿",
      score: "",
      value: ""
    };
  },
