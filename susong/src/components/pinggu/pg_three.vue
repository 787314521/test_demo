<template>
  <div id="box">
    ...
    <el-radio-group v-model="selectionsList[2].value" @change="changeValue">
      ...
      <el-radio v-model="radio1" label="6" class="el-radio6">{{six}}</el-radio>
    </el-radio-group>
    <!-- 返回上一页 -->
    <el-row>
...
export default {
  data() {
    return {
      ...
      radio1: "",
      one: "残疾人无固定生活来源",
      two: "追索赡养费、抚养费、抚育费、抚恤金",
      three: "低保户、特困户、五保户",
      four:"领取失业保险金人员，无其他收入",
      five:"因见义勇为致使自身权益受损，请求赔偿或补偿",
      six:"没有上述情况",
      score: "",
      value: ""
    };
  ...
  methods: {
    changeValue(e){
      ...
      let _this=this
      setTimeout(function(){
        _this.$router.push({path:'/pg_four'})
      },300)
    },
    v_click(){
