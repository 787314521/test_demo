...
export default {
  data() {
    return {
      title: "您申请诉讼保全具备以下哪些条件？",
      one: "我已提起了诉讼，案件受理后尚未作出生效判决",
      two: "我已提起了诉讼且案件已作出了一审判决，但尚未生效",
      three: "不申请保全可能使判决难以执行或者对我造成损害",
      four: "我已提供担保（物的担保、现金担保、人的担保、保险担保）",
      five: "没有以上情况",
      checkList: [],
      value: 0,
      score1: "",
  ...
  methods: {
    ...
    isOk() {
      ...
      if (this.checkList != "") {
        this.$router.push({ path: "/ss_three" });
      } else {
        this.$alert("请选择选项！", "提示", {
