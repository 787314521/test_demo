...
export default {
  data() {
    return {
      ...
      three: "我知道被执行人的大致范围，但是不确定具体地址",
      four: "我知道被执行人的微信号，支付宝账号、QQ号或者邮箱账号",
      five: "我不知道被执行人的经常居住地，但是能找到他",
      six: "我找了多次找不到被执行人",
      checkList: [],
      value: "",
      score1: "",
  ...
  methods: {
    ...
    isOk() {
      ...
      localStorage.setItem("key10", this.value + this.score);

      if (this.checkList != "") {
        this.$router.push({ path: "/ms_eleven" });
      } else {
        this.$alert("请选择选项！", "提示", {
